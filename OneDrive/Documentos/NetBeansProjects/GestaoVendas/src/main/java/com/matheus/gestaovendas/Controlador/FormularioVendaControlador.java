...
import com.matheus.gestaovendas.modelo.util.ValidarCPFouCNPJ;
...
import com.matheus.gestaovendas.modelo.ModelosTabela.VendaItemModelo;
import com.matheus.gestaovendas.modelo.ModelosTabela.VendaModelo;
import com.matheus.gestaovendas.modelo.dto.VendaItemDto;
import com.matheus.gestaovendas.modelo.dto.VendaRequestDto;
...
import com.matheus.gestaovendas.modelo.repositorio.impl.VendaItemRepositorioImpl;
import com.matheus.gestaovendas.modelo.repositorio.impl.VendaRepositorioImpl;
import com.matheus.gestaovendas.modelo.servico.CategoriaServico;
...
import com.matheus.gestaovendas.visao.formulario.FormularioVenda;
...
public class FormularioVendaControlador implements ActionListener, KeyListener, MouseListener {
    ...
    private final long PERMISSAO_ID_PARA_SALVAR_VENDA = 13;
    private final long PERMISSAO_ID_PARA_ATUALIZAR_VENDA = 14;
    private final long PERMISSAO_ID_PARA_REMOVER_VENDA = 15;
    ...
    private void validaCliente(String cliente) {
        if (!ValidarCPFouCNPJ.isCPF(cliente) && !ValidarCPFouCNPJ.isCNPJ(cliente)) {
...
//        limpezaGeral();
    ...
    private void removerVenda() {
        ...
        if (venda != null) {
            int confirma = JOptionPane.showConfirmDialog(null, "Tem certeza?", "Remover venda", JOptionPane.YES_NO_OPTION);
