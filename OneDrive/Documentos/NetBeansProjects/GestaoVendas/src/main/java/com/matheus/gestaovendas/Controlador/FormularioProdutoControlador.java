...
import com.matheus.gestaovendas.modelo.ModelosTabela.CategoriaModelo;
...
public class FormularioProdutoControlador implements ActionListener, KeyListener, MouseListener {
    ...
    private void salvaProduto() {
            ...
            if (mensagem.startsWith("Produto cadastrado com sucesso")) {
                  formularioProduto.getFormulario().mostrMensagem(Mensagem.TipoDeMensagem.SUCESSO, mensagem);
                  limpaCampoProduto();
                  atualizaTabela();
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        switch(action) {
            ...
            case "imprimir" -> {}
            case "salvarproduto" -> { salvaProduto(); }
            case "salvarcategoria" -> { salvaCategoria(); }
        }
