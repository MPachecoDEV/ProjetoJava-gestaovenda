...
import com.matheus.gestaovendas.modelo.ModelosTabela.UsuarioModelo;
import com.matheus.gestaovendas.modelo.entidade.Permissao;
import com.matheus.gestaovendas.modelo.entidade.PermissaoUsuario;
...
import com.matheus.gestaovendas.visao.formulario.FormularioUsuario;
...
public final class FormularioUsuarioControlador implements ActionListener, KeyListener {
    ...
    private final long PERMISSAO_ID_PARA_ENCONTRAR_SOMENTE_TEUS_USUARIO = 2;
    private final long PERMISSAO_ID_PARA_ENCONTRAR_TODOS_USUARIO = 3;
    private final long PERMISSAO_ID_PARA_REMOVE_PELO_ID_USUARIO = 4;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        switch (action) {
            ...
            case "salvar" -> { salvar(); }
            case "selecionar" -> { selecionaArquivo(); }
        }
    }
    ...
    private void salvar() {
        ...
        formularioUsuario.getDialogCadastro().setVisible(false);
    }
    ...
    private void limpaPermissao() {
        ...
        formularioUsuario.getLabelPermissaoMensagem().setText("");
    }
    ...
    private Usuario selectionaUsuarioNaTabela() {        
        if (formularioUsuario.getTabelaUsuario().getSelectedRow() != -1) {
            ...
            String message = "É necessario selecionar usuario na tabela";
