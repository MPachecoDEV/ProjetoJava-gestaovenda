...
public class Mensagem extends javax.swing.JPanel {
    ...
    public void mostrarMensagem(TipoDeMensagem tipoDeMensagem, String mensagem) {
        ...
        if (tipoDeMensagem.equals(TipoDeMensagem.SUCESSO)) {
            labelMensagem.setIcon(new ImageIcon(System.getProperty("user.dir") + "\\src\\main\\java\\com\\matheus\\gestaovendas\\visao\\icon\\sucesso.png"));
        } else {
            labelMensagem.setIcon(new ImageIcon(System.getProperty("user.dir") + "\\src\\main\\java\\com\\matheus\\gestaovendas\\visao\\icon\\erro.png"));
        }
    }
